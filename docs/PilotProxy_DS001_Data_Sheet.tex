...
\code{docs/product_schema_v3.md}.
...
and the ragged any-bin detection list). \code{docs/product_schema_v2.md}
defines the shared arrays and \code{docs/product_schema_v3.md} the
