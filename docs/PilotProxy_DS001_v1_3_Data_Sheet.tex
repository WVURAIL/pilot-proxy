...
\fancyfoot[L]{\small PilotProxy-DS001 v1.3}
...
\title{PilotProxy CUDA F-Statistic DTV Pilot Detector v0.1.0\\Product Specification}
\author{West Virginia University}
\date{PilotProxy-DS001 v1.3 \\ May 29, 2026}
...
\begin{minipage}[t]{0.39\textwidth}
  ...
  {\small PilotProxy-DS001 v1.3, May 29, 2026}
\end{minipage}
\hfill
\begin{minipage}[t]{0.58\textwidth}
  \raggedleft
  {\fontsize{18}{20}\selectfont\bfseries CUDA F-Statistic DTV Pilot Detector v0.1.0}\par
...
\begin{itemize}
  \item v0.1.0 is source-tree/editable-install oriented.  Wheel packaging of CUDA and weight resources is not the primary supported mode.
  \item The CUDA API is default-stream only.
  \item The shipped weight bank covers physical channels 14-36 only.
  \item Standalone validation is GNU Radio ATSC synthetic validation only; there is no CHIME/baseband file reader in v0.1.0.
  \item Receiver profiles are an integration contract, not a validated telescope pipeline.
  \item No operational threshold is derived from real telescope null statistics in v0.1.0.
