...
\vfill
{\small\color{FStatGray}This product specification defines the standalone v0.1.0 detector contract.  The standalone synthetic detector supports thresholded operation; the CHIME real-data workflow uses thresholdless positive-excess masking.  Performance is GPU-, compiler-, and integration-dependent and should be measured on the target system.}
