...
\fancyfoot[L]{\small PilotProxy-UG001 v1.3}
...
\date{PilotProxy-UG001 v1.3 \\ May 29, 2026}
...
\vspace{0.35in}
{\large PilotProxy-UG001 v1.3}\par
...
CHIME/CANFAR mode & The standalone synthetic detector supports thresholded operation; the CHIME real-data workflow uses thresholdless positive-excess masking.\\ \hline
