...
\usepackage[hidelinks,
  pdftitle={A pilot-informed local-reference power-ratio detector for digital television
...
\title{A pilot-informed local-reference power-ratio detector for digital television\\
in CHIME baseband data\\
