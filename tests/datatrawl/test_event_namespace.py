...
from pilot_proxy.datatrawl_plugins._chime_coarse import source_event_key
from pilot_proxy.datatrawl_plugins.combine import _align_frames, combine_detector_products
