...
struct Options {
    std::string serial, tx_file, rx_file, status_file, startup_file, chunks_file;
...
Options parse(int argc, char** argv) {
    ...
    o.startup_file=get("--startup-file"); o.chunks_file=get("--chunks-file");
    require(values.size() == 13, "Unknown argument");
...
int run(const Options& o) {
    ...
    Output rx_output(o.rx_file), status_output(o.status_file), startup_output(o.startup_file), chunks_output(o.chunks_file);
